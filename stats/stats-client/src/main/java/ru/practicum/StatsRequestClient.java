...
@Service
@Slf4j
public class StatsRequestClient extends BaseRequestClient {

    @Autowired
    public StatsRequestClient(@Value("${stats-server.url}") String serverUrl, RestTemplateBuilder builder) {
